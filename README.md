...
[`google_hourly_search_trends` CSV File](Resources/google_hourly_search_trends.csv)

[`mercado_daily_revenue` CSV File](Resources/mercado_daily_revenue.csv)

[`mercado_stock_price` CSV File](Resources/mercado_stock_price.csv)
